...
# Wrapper function a parallel call of mice using the parLapply
# function.
...
# Wrapper function a parallel call of mice using the furrr
# function.
furrr_wrap <- function(data, num_imp, seed, num_cores) {
