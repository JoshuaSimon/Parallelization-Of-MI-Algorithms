...
\begin{columns}
	...
	\block{Theory}{
		...
		Multiple imputation is a method to complete a dataset with missing information. It relies on the estimation of the missing values through different methods. What is common to them is that we use not a single
	}
	\block{Methodology}{
