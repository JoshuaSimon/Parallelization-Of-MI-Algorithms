...
\begin{columns}
	...
	The \textcolor{earthyellow}{\textbf{method}} of the \textcolor{earthyellow}{\textbf{mice}} algorithm was set on defaut for numeric data, pmm.\\
    ...
    \block{Results}{
        ...
        \vspace{1em}
			\begin{tikzfigure}[Runtime and Speedup from 1 up to 16 cores]
				\includegraphics[width=1\linewidth]{img/runtime_ncores_speedup}
			\end{tikzfigure}
        \vspace{1em}
       
       	\vspace{1em}
			\begin{tikzfigure}[Runtime and Speedup from 4 up to 128 Imputation runs on a quad-core CPU]
      	...
      	\vspace{1em}
			...
			\begin{tikztable}[Time components for the different implementations on 16 cores]
				...
				\begin{tabular}{rlrrrrr}
					...
					4 & future.apply & 16 & 0.89 & 0.07 & 7.99 & 3.90 \\ 
					5 & mice (serial) & 16 & 31.04 & 0.06 & 31.11 & 1.00 \\ 
					6 & mice.par & 16 & 1.15 & 0.10 & 13.67 & 2.50 \\ 
					7 & parLapply & 16 & 0.33 & 0.04 & 7.80 & 4.39 \\ 
					8 & parLapply\_fork & 16 & 0.23 & 0.17 & 6.40 & 5.36 \\ 
					9 & parlmice & 16 & 0.30 & 0.02 & 7.76 & 4.41 \\ 
					10 & parlmice\_fork & 16 & 0.21 & 0.18 & 6.54 & 5.25 \\ 
					\hline
				\end{tabular}
			\end{tikztable}
    	\vspace{1em} 
	...
	\block{Conclusion}{
		\begin{itemize}
			...
			\item When parallelizing multiple imputations, mice's built in \textbf{parlmice} function is recommended. It utilizes parLapply under the hood, which results in good performance, but it's easier to use. \textbf{mice.par} should be avoided due to poor performance.
